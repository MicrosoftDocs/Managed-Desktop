...
Microsoft Managed Desktop provides the same scope of service with virtual machines as it does with [physical devices](../service-description/device-services.md). However, Microsoft Managed Desktop defers any Azure Virtual Desktop specific support to Azure support unless otherwise specified.

### Prerequisites

Microsoft Managed Desktop for Azure Virtual Desktop follows the same [prerequisites](../get-ready/prerequisites.md) as Microsoft Managed Desktop, and the [Azure Virtual Desktop prerequisites](/azure/virtual-desktop/prerequisites).  
