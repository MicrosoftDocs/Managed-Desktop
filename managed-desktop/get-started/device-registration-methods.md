...
| **Step 4: Check for assigned devices** | Microsoft Managed Desktop has a function that checks for assigned devices in all three Microsoft Managed Desktop Windows Autopilot profiles every hour.<ol><li>The three Windows Autopilot Deployment profiles supported in Microsoft Managed Desktop are:</li><ol><li>**Modern Workplace Autopilot Profile**</li><li>**Modern Workplace Autopilot Profile Power User**</li><li>**Modern Workplace Autopilot Profile Shared**</li><li>**[Modern Workplace Autopilot Profile Kiosk](../service-description/profiles.md#device-profile-details)**</li></ol><li>If there are newly added devices, these devices are added into the Microsoft Managed Desktop shipped device record database.</li><li>Microsoft Managed Desktop flags the device(s) with the status **Registration pending** in the **Devices** blade.</li></ol> |
...
| **Step 8: Assign device configuration profiles to devices** | Microsoft Managed Desktop assigns the device configuration profiles to devices. For more information, see [Device profiles](/managed-desktop/service-description/profiles). The device configuration profiles are defined as:<ol><li>**Standard**</li><li>**Sensitive data**</li><li>**Power User**</li><li>**[Kiosk](../service-description/kiosk-device-profile.md)**</li></ol> |
...
| **Step 15: Assign device configuration profiles to devices** | Microsoft Managed desktop assigns device configuration profiles to devices. For more information, see [Device profiles](/managed-desktop/service-description/profiles) for more details. The device configuration profiles are:<ol><li>**Standard**</li><li>**Sensitive data**</li><li>**Power User**</li><li>**[Kiosk](../service-description/kiosk-device-profile.md)**</li></ol> |
| **Step 16: Validate devices** | Microsoft Managed Desktop validates whether devices are part of the assigned devices in one of the Windows Autopilot Deployment profiles.<ol><li>Microsoft Managed Desktop checks for assigned devices in all three Microsoft Managed Desktop Windows Autopilot profiles every hour.</li><li>The three Windows Autopilot Deployment profiles supported in Microsoft Managed Desktop are:<ol><li>**Modern Workplace Autopilot Profile**</li>**Modern Workplace Autopilot Profile Power User**</li><li>**Modern Workplace Autopilot Profile Shared**</li><li>**[Modern Workplace Autopilot Profile Kiosk](../service-description/profiles.md#device-profile-details)**</li></ol><li>If there are newly added devices, these devices are added into the Microsoft Managed Desktop shipped device record database.</li></ol> |
