...
Part of onboarding to Microsoft Managed Desktop includes adding and deploying apps to your user's devices. Once you're using the [Microsoft Intune admin center](https://go.microsoft.com/fwlink/?linkid=2109431), you can add and deploy your apps.

The overall process looks like this:

1. [Add apps to Microsoft Intune admin center](#step-1-add-apps-to-microsoft-intune-admin-center): These apps can be existing line-of-business (LOB) apps, or apps from Microsoft Store for Business that you've synced with Intune.
2. [Create Azure Active Directory (AD) groups for app assignment](#step-2-create-azure-ad-groups): You'll use these groups to manage app assignment.
3. [Assign apps to your users](#step-3-assign-apps-to-your-users).
...
## Step 1: Add apps to Microsoft Intune admin center
...
You can add your line-of-business (LOB) apps to Microsoft Intune admin center. For requirement information for apps installed on Microsoft Managed Desktop devices, see [Microsoft Managed Desktop app requirements](../prepare/app-requirements.md).

In this procedure, you'll select which kind of app you want to add, and then configure and upload the app source.

**To add your LOB app or Windows app to Microsoft Intune admin center:**
