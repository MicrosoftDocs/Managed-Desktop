...
> [!IMPORTANT]
> <ul><li>Existing European Union (EU) customers are moving from the North American data centers to the European data centers by the end of 2022.</li><li>If you're an existing Microsoft Managed Desktop customer, but **not** part of the European Union, data migration from North America to your respective data residency will occur next year.</li><li>As of Oct 31, 2022, only **new** Microsoft Managed Desktop customers (EU, UK, Africa, Middle East) will have their data live in the European data centers.</li></ul>
