...
You can reimage devices either with an image from the manufacturer, or by using the [Microsoft Managed Desktop "universal image."](https://docs.microsoft.com/en-us/managed-desktop/service-description/universal-image?view=o365-worldwide) To get an appropriate manufacturer image, order at least one [new device](#new-devices) of the model you're reusing. Then, you can obtain the image from that device and apply it to other devices of the exact same model.
