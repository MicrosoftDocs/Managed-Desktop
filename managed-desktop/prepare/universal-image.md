...
Submit requests for the universal image by creating a change request in the [admin center](../operate/support-request.md). You'll receive instructions on how to download the universal image.

> [!TIP]
> To enable rapid testing and validation of the Microsoft Managed Desktop platform in your Hyper-V environment, you'll need a VHDX file. To obtain the VHDX file, [submit a request](../operate/support-request.md).
...
| Surface | [Download drivers and firmware for Surface](https://support.microsoft.com/surface/download-drivers-and-firmware-for-surface-09bb2e09-2a4b-cb69-0951-078a7739e120) |
...
| Question | Answer |
| ----- | ----- |
| Where can I get the universal image? | Please [submit a request via the admin center](../operate/support-request.md) to the Microsoft Managed Desktop team. |
