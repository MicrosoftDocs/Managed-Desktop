...
| **Step 4: Check for assigned devices** | Microsoft Managed Desktop has a function that checks for assigned devices in all three Microsoft Managed Desktop Windows Autopilot profiles every hour.<ol><li>The three Windows Autopilot Deployment profiles supported in Microsoft Managed Desktop are:</li><ol><li>**Modern Workplace Autopilot Profile**</li><li>**Modern Workplace Autopilot Profile Power User**</li><li>**Modern Workplace Autopilot Profile Shared**</li><li>**[Modern Workplace Autopilot Profile Kiosk](../operate/device-profiles.md#device-profile-details)**</li></ol><li>If there are newly added devices, these devices are added into the Microsoft Managed Desktop shipped device record database.</li><li>Microsoft Managed Desktop flags the device(s) with the status **Registration pending** in the **Devices** blade.</li></ol> |
