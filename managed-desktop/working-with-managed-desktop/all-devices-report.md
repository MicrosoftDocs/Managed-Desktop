...
| Update status | The current update status for the device (see [Windows quality update status](reports.md#windows-quality-update-statuses). |
| Update sub status | The current update sub status for the device (see [Windows quality update status](reports.md#windows-quality-update-statuses). |
